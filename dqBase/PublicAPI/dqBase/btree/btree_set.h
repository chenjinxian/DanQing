...
// Ported from: imodel-native iModelCore/Bentley/PublicAPI/Bentley/btree/btree_set.h
...
//   Identifier rename + include repoint as in btree.h. CLAUDE.md §7.3: do not replace with std::set.
/*---------------------------------------------------------------------------------------------
...
template <typename Key,
	...
	typename Alloc = dqBase::DqAllocator<Key>>
