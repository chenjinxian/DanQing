...
// Ported from: imodel-native iModelCore/Bentley/PublicAPI/Bentley/CodePages.h
// DanQing dqBase — 代码页枚举
//
// 1:1 对齐 imodel-native LangCodePage。
#pragma once
...
// ---------------------------------------------------------------------------
// LangCodePage — 语言代码页
// Ported from: imodel-native CodePages.h
// ---------------------------------------------------------------------------
enum class LangCodePage : int32_t {
