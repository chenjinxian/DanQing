...
// Ported from: imodel-native iModelCore/Bentley/PublicAPI/Bentley/simple_segregated_storage.h
//   Original upstream: Boost.Pool boost/pool/simple_segregated_storage.hpp (BSL 1.0,
//   (C) 2000-2001 Stephen Cleary).
...
//   underlying free-list allocator for bpool.h on a performance-critical path.
/*---------------------------------------------------------------------------------------------
...
#ifndef DQ_BASE_SIMPLE_SEGREGATED_STORAGE_HPP
#define DQ_BASE_SIMPLE_SEGREGATED_STORAGE_HPP
...
#ifdef DQ_BASE_POOL_VALIDATE
#  define DQ_BASE_POOL_VALIDATE_INTERNALS validate();
#else
#  define DQ_BASE_POOL_VALIDATE_INTERNALS
#endif
...
class simple_segregated_storage
{
  ...
  public:
    ...
    { //! Add block
      ...
      //!  \post !empty()
      DQ_BASE_POOL_VALIDATE_INTERNALS
